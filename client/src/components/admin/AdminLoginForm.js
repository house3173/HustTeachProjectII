...
const AdminLoginForm = () => {
    ...
    const {actorState, dispatch, loginAdmin} = useContext(ActorContext)
		...
		try {
            ...
            console.log(loginData)
                if(loginData.success) {
                    setActorState('adminMainHome', '/admin31072003/trang-chu')
                    navigate('/admin31072003/trang-chu')
                }
		} catch (error) {
			console.log(error)
		}
        ...
        <Container className='mb-30'>
            <Row className="mt-5">
                ...
                <Col style={{padding: '0 40px', textAlign: "center"}}>
                    <div className='mb-20'>
                        <span style={{color: "#00b050", fontSize: "26px"}}><strong>{`Đăng nhập tài khoản admin`} </strong></span>
                    </div>
